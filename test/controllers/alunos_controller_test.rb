...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { nome: @aluno.nome, ra: @aluno.ra, serie: @aluno.serie, turno: @aluno.turno } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { nome: @aluno.nome, ra: @aluno.ra, serie: @aluno.serie, turno: @aluno.turno } }
